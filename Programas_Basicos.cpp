...
int main()
{
     int m,opcion;	
        ...
        cout << "17. Pedir datos del usuario" << endl;
        cout << "18. Calcular El Area de un triangulo" << endl;
        cout << "19. Mostrar numeros pares hasta  el 30 " << endl;
   ...
   case 10:cout<<">>Crear de forma grafica la multiplicacion manual<<"<<endl;
    ...
    case 17:cout<<">>Pedir datos al usuario<<"<<endl;
     {int edad;
     char sexo[10];
     float altura;
     ...
     cout<<"nEdad: "<<edad<<endl;
     cout<<"Sexo: "<<edad<<endl;
     cout<<"Altura en metros: "<<edad<<endl;
     return 0;
	 }
